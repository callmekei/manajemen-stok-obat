				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="<?= base_url('/insert_obat_keluar_process') ?>" method="POST">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="custom-select2 form-control" id="id_konsumen" name="id_konsumen">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="sub_total" name="sub_total" type="text" readonly>
							</div>
						</div>
						<div class="form-group row">
...
<script>
$(document).ready(function() {
    $('#id_konsumen').on('change', function() {
        ...
        if (selectedKonsumen) {
            ...
            $('#nama_konsumen').val(selectedKonsumen['nama']);
            $('#alamat').val(selectedKonsumen['alamat']);
            $('#no_telp').val(selectedKonsumen['no_telp']);
        } else {
