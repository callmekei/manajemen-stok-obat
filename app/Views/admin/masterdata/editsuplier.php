		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Edit Data Suplier</h4>
						</div>
					</div>
					...
					<?php endif; ?>
					<form action="<?= base_url('/edit_suplier_process') ?>" method="POST">
                    <input type="hidden" class="form-control" id="id_suplier" name="id_suplier" value="<?= $data_suplier->id_suplier ?>">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Suplier</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="nama" name="nama" type="text" value="<?= $data_suplier->nama ?>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Alamat</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="alamat" name="alamat" type="text" value="<?= $data_suplier->alamat ?>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">No Telepon</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="no_telp" name="no_telp" type="text" value="<?= $data_suplier->no_telp ?>">
							</div>
						</div>
                        <div class="mb-3">
