...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Edit Data Satuan Obat</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Edit Data Satuan Obat</h4>
						</div>
					</div>
					...
					<?php endif; ?>
					<form action="<?= base_url('/edit_satuan_process') ?>" method="POST">
						<input type="hidden" class="form-control" id="id_satuan" name="id_satuan" value="<?= $data_satuan->id_satuan ?>">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Satuan Obat</label>
							<div class="col-sm-12 col-md-10">
								<?php
								$inputValue = isset($validation_failed) ? '' : $data_satuan->satuan;
								?>
								<input class="form-control" id="satuan" name="satuan" type="text" value="<?= $inputValue ?>">
								<?php if (isset($validation_failed) && isset($errors['satuan'])) : ?>
									<small class="text-danger"><?= $errors['satuan'] ?></small>
								<?php endif; ?>
							</div>
						</div>
						<div class="mb-3">
