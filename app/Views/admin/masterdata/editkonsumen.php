		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Edit Data Konsumen</h4>
						</div>
					</div>
					<form action="<?= base_url('/edit_konsumen_process') ?>" method="POST">
                    <input type="hidden" class="form-control" id="id_konsumen" name="id_konsumen" value="<?= $data_konsumen->id_konsumen ?>">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Konsumen</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="nama" name="nama" type="text" value="<?= $data_konsumen->nama ?>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Alamat</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="alamat" name="alamat" type="text" value="<?= $data_konsumen->alamat ?>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">No Telepon</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" id="no_telp" name="no_telp" type="text" value="<?= $data_konsumen->no_telp ?>">
							</div>
						</div>
                        <div class="mb-3">
