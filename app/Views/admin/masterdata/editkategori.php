...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Edit Data Kategori Obat</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Edit Data Kategori Obat</h4>
						</div>
					</div>
					...
					<?php endif; ?>
					<form action="<?= base_url('/edit_kategori_process') ?>" method="POST">
						<input type="hidden" class="form-control" id="id_kategori" name="id_kategori" value="<?= $data_kategori->id_kategori ?>">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Kategori Obat</label>
							<div class="col-sm-12 col-md-10">
								<?php
								$inputValue = isset($validation_failed) ? '' : $data_kategori->kategori;
								?>
								<input class="form-control" id="kategori" name="kategori" type="text" value="<?= $inputValue ?>">
								<?php if (isset($validation_failed) && isset($errors['kategori'])) : ?>
