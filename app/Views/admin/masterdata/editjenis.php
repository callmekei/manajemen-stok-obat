...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Edit Data Jenis Obat</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Edit Data Jenis Obat</h4>
						</div>
					</div>
					...
					<?php endif; ?>
					<form action="<?= base_url('/edit_jenis_process') ?>" method="POST">
					<input type="hidden" class="form-control" id="jenis" name="id_jenis" value="<?= $data_jenis->id_jenis ?>">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Jenis Obat</label>
							<div class="col-sm-12 col-md-10">
								<?php
								$inputValue = isset($validation_failed) ? '' : $data_jenis->jenis;
								?>
								<input class="form-control" id="jenis" name="jenis" type="text" value="<?= $inputValue ?>">
								<?php if (isset($validation_failed) && isset($errors['jenis'])) : ?>
									<small class="text-danger"><?= $errors['jenis'] ?></small>
								<?php endif; ?>
							</div>
						</div>
						<div class="mb-3">
