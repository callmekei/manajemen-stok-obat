...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Insert Data Kategori Obat</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Input Data Kategori Obat</h4>
						</div>
					</div>
					<form action="<?= base_url('/insert_kategori_process') ?>" method="POST">
						<div class="col-md-6">
								<div class="form-group row">
									<label for="nama">Kategori Obat</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control <?php if (session('errors.kategori')) echo 'is-invalid'; ?>" id="kategori" name="kategori" type="text" value="<?= old('kategori'); ?>">
							...
							<div class="mb-3">
							<a href="<?= base_url('/kategori_obat'); ?>" class="btn btn-danger ml-3">Cancel</a>
